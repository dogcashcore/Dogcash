...
#ifndef PRODUCTIONCHAIN_VALIDATION_H
#define PRODUCTIONCHAIN_VALIDATION_H
...
static const int64_t DEFAULT_MAX_TIP_AGE = 240 * 60 * 60;
...
#endif // PRODUCTIONCHAIN_VALIDATION_H
