/* src/config/dogcash-config.h.  Generated from dogcash-config.h.in by configure.  */
/* src/config/dogcash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PRODUCTIONCHAIN_CONFIG_H

#define PRODUCTIONCHAIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The DogCash Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "DogCash Core"
...
#define PACKAGE_BUGREPORT "https://github.com/DogCashProject/DogCash/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "DogCash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DogCash Core 1.5.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dogcash"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://dogcash.org/"
...
#endif //PRODUCTIONCHAIN_CONFIG_H
