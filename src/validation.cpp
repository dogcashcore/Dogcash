...
#if defined(NDEBUG)
# error "DogCash cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "DogCash Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s DCH additional fees, %d delta bytes\n",
    ...
    if (halvings >= 64)
{
    ...
    else if (nHeight >= 1 && nHeight <= 99999)
	{
        nSubsidy = 500000 * COIN;
	}

    else if(nHeight > 99999 && nHeight <= 200000)
    {
        nSubsidy = 50000 * COIN;
    }
	...
	else if(nHeight > 500000 && nHeight <= 886509001)
    {
        nSubsidy = 50 * COIN;
    }
       return nSubsidy;
